...
import DifferenceAlgebraLemmaCanonicalLaneLean.MathlibObjects
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedDifferenceClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_difference_endgame A
